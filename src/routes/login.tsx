			...
			<section className="grid min-h-[calc(100vh-10rem)] place-items-center max-sm:min-h-[calc(100vh-8rem)]">
				<div className="island-shell w-full max-w-md rounded-2xl p-8">
					...
					<button
						...
						className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--line)] bg-[var(--surface)] px-4 py-3 font-semibold text-[var(--sea-ink)] transition hover:bg-[var(--link-bg-hover)]"
					>
						<svg
							viewBox="0 0 24 24"
							width="20"
